...
export default class Home extends React.Component {
      ...
      <React.Fragment>
        <DisplayRow>
          <DropDown>
            ...
            <DropDownSelect
              value={this.state.form.typeOfRelief}
              name="typeOfRelief"
          ...
          <DropDown>
            ...
            <DropDownSelect
              value={this.state.form.typeOfOrganization}
  ...
  getOrgType = page => {
    return page.fields.organization_type.map(t =>
      this.clean(t.organization_type)
    );
  };
    ...
    const filteredPageData = pageData.filter(page => {
      return (
        ...
        (this.match([this.getLocation(page)], location) ||
          this.getLocation(page) === "unitedstates")
      );
    });
      ...
      <PageContainer className="background-gradient">
        ...
        <BodyContainer className="container mx-auto">
          <TitleSection>
            ...
            <Section>
              <Description>
                Find the latest relief available to your organization during the
                COVID-19 crisis. Access the grants, loans, and services to help
            ...
            <Display>
              <Flex>
                <div>
                  ...
                  <DisplayTitleSub>
                    See what types of relief are available to your organization
                    today.
                  </DisplayTitleSub>
                </div>
                <div>
